...
export default function ClothingAccessoriesModule() {
        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerInfo}>
              <Text style={styles.headerTitle}>Clothing & Accessories</Text>
              <Text style={styles.headerSubtitle}>Clothes, shoes, accessories, describing outfits</Text>
            </View>
  ...
  // Clothing & Accessories specific topics
