...
export default function NumbersCountingModule() {
        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerInfo}>
              <Text style={styles.headerTitle}>Numbers & Counting</Text>
              <Text style={styles.headerSubtitle}>Numbers 1–100, basic addition/subtraction terms</Text>
            </View>
  ...
  // Numbers & Counting specific topics
