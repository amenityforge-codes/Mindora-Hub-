...
export default function AdjectivesDescriptionsModule() {
        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerInfo}>
              <Text style={styles.headerTitle}>Adjectives & Descriptions</Text>
              <Text style={styles.headerSubtitle}>Describing objects, people, comparisons</Text>
            </View>
  ...
  // Adjectives & Descriptions specific topics
