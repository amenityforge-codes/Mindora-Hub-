...
export default function SchoolEducationModule() {
        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerInfo}>
              <Text style={styles.headerTitle}>School & Education</Text>
              <Text style={styles.headerSubtitle}>Subjects, school supplies, classroom expressions</Text>
            </View>
  ...
  // School & Education specific topics
