...
export default function TimeCalendarModule() {
        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerInfo}>
              <Text style={styles.headerTitle}>Time & Calendar</Text>
              <Text style={styles.headerSubtitle}>Days, months, telling time</Text>
            </View>
