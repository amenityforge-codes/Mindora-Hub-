        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerInfo}>
              <Text style={styles.headerTitle}>Colors & Shapes</Text>
              <Text style={styles.headerSubtitle}>Color names, shape recognition, comparisons</Text>
            </View>
