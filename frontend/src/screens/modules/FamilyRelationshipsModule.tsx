...
export default function FamilyRelationshipsModule() {
        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerInfo}>
              ...
              <Text style={styles.headerSubtitle}>Vocabulary for family members, friends, greetings</Text>
            </View>
  ...
  // Family & Relationships specific topics
