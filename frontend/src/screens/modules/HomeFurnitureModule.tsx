...
export default function HomeFurnitureModule() {
        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerInfo}>
              <Text style={styles.headerTitle}>Home & Furniture</Text>
              <Text style={styles.headerSubtitle}>Rooms, furniture names, household items</Text>
            </View>
  ...
  // Home & Furniture specific topics
