...
export default function BodyPartsHealthModule() {
        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerInfo}>
              <Text style={styles.headerTitle}>Body Parts & Health</Text>
              <Text style={styles.headerSubtitle}>Human body parts, basic health vocabulary</Text>
            </View>
  ...
  // Body Parts & Health specific topics
