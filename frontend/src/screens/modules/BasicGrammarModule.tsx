...
export default function BasicGrammarModule() {
        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerInfo}>
              <Text style={styles.headerTitle}>Basic Grammar</Text>
              <Text style={styles.headerSubtitle}>Sentence structure, nouns, verbs, simple tenses</Text>
            </View>
