...
export default function BasicVocabularyModule() {
        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerInfo}>
              <Text style={styles.headerTitle}>Basic Vocabulary</Text>
              <Text style={styles.headerSubtitle}>Words for objects, animals, people, and daily life</Text>
            </View>
  ...
  // Basic Vocabulary specific topics
