...
export default function AnimalsNatureModule() {
        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerInfo}>
              <Text style={styles.headerTitle}>Animals & Nature</Text>
              <Text style={styles.headerSubtitle}>Wild vs domestic animals, natural elements</Text>
            </View>
  ...
  // Animals & Nature specific topics
