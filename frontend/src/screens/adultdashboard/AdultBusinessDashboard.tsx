        ...
        >
          <View style={styles.headerTop}>
            <View style={styles.headerLeft}>
              ...
              <Text style={styles.userName}>Business Professional! 🏢</Text>
            </View>
    ...
    const actions = [
      {
        ...
        icon: 'group',
        color: '#45B7D1',
        onPress: () => navigation.navigate('LeadershipModule'),
      },
      {
        ...
        color: '#4ECDC4',
        onPress: () => navigation.navigate('FinanceModule'),
      },
      {
        title: 'Negotiation',
        ...
        icon: 'handshake',
        color: '#96CEB4',
        onPress: () => navigation.navigate('NegotiationModule'),
      },
      {
        title: 'AI & Technology',
        ...
        icon: 'computer',
        color: '#FFB74D',
        onPress: () => navigation.navigate('AIModule'),
      },
    ];
