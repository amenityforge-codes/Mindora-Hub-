  ...
  const loadModules = async () => {
    try {
      ...
      if (data.success) {
        ...
        const softSkillsModules = data.data.modules
          .filter((module: any) => module.moduleType === 'soft-skills')
          .map((module: any) => ({
            _id: module._id,
            title: module.title,
            description: module.description,
            difficulty: module.difficulty.charAt(0).toUpperCase() + module.difficulty.slice(1) as 'Beginner' | 'Intermediate' | 'Advanced',
