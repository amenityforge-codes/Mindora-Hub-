...
const ExamManagementScreen: React.FC = () => {
  ...
  const loadExams = async () => {
    try {
      setLoading(true);
      console.log('Loading exams with API service...');
  ...
  const handleCreateExam = async () => {
    try {
      ...
      const data = await apiService.post('/exams', examData);
    ...
    try {
      ...
      if (data.success) {
        ...
        try {
          ...
          await apiService.put(`/exams/${editingExam._id}`, examUpdateData);
        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              const data = await apiService.delete(`/exams/${id}`);
          ...
          onPress: async () => {
            try {
              ...
              if (editingExam) {
                ...
                await apiService.put(`/exams/${editingExam._id}`, {
                  questions: updatedQuestions
                });
              }
