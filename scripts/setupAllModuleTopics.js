...
async function setupAllModuleTopics() {
  try {
    console.log('=== SETTING UP ALL MODULES AND TOPICS ===');
    ...
    // Create all modules with their topics
    ...
    console.error('Error setting up modules and topics:', error);
    process.exit(1);
  }
}
