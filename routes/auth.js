...
router.post('/register', authRateLimit, registerValidation, async (req, res) => {
  try {
    ...
    const { name, email, password, ageRange, role = 'student', phone, location } = req.body;
    ...
    const user = new User({
      ...
      password,
      role,
      ageRange: role === 'student' || role === 'professional' ? ageRange : undefined,
      profile: {
        phone,
        location
      }
